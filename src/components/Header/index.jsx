    ...
    return(
        <div>
            <div className='md:block '>
                ...
                <div className='fixed z-40 top-0 right-10 md:top-1/2 md:right-0 h-10 md:h-0 md:w-10 flex md:flex-col justify-center items-center gap-x-5 md:gap-x-0 md:gap-y-5  md:-translate-y-1/2'>
